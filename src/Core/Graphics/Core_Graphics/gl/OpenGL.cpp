...
namespace Core{
   OpenGL::OpenGL(Core::Window& window){
      ...
      FETCH_GL_FUNC(PFNGLCLEARDEPTHFPROC, glClearDepthf);
      ...
      FETCH_GL_FUNC(PFNGLGETACTIVEUNIFORMNAMEPROC, glGetActiveUniformName);
      FETCH_GL_FUNC(PFNGLGETACTIVEUNIFORMSIVPROC, glGetActiveUniformsiv);
      FETCH_GL_FUNC(PFNGLGETACTIVEUNIFORMBLOCKIVPROC, glGetActiveUniformBlockiv);
      FETCH_GL_FUNC(PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC, glGetActiveUniformBlockName);
      ...
      FETCH_GL_FUNC(PFNGLUNIFORM1FVPROC, glUniform1fv);
      FETCH_GL_FUNC(PFNGLUNIFORM2FVPROC, glUniform2fv);
      FETCH_GL_FUNC(PFNGLUNIFORM3FVPROC, glUniform3fv);
      FETCH_GL_FUNC(PFNGLUNIFORM4FVPROC, glUniform4fv);
      FETCH_GL_FUNC(PFNGLUNIFORM1IVPROC, glUniform1iv);
      FETCH_GL_FUNC(PFNGLUNIFORM2IVPROC, glUniform2iv);
      FETCH_GL_FUNC(PFNGLUNIFORM3IVPROC, glUniform3iv);
      FETCH_GL_FUNC(PFNGLUNIFORM4IVPROC, glUniform4iv);
      FETCH_GL_FUNC(PFNGLUNIFORMMATRIX4FVPROC, glUniformMatrix3fv);
